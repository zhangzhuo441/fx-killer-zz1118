...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return generateBilingualMetadata(
    ...
    'Partner Brokers丨Space-time trading丨Day Trader Training, Full-Time Trader Training',
    '时空交易官方合作经纪商：EC Markets、TickMill、Binance、FTMO、FundedNext。为外汇交易员提供平台最高返佣、超低点差和独家优惠。支持日内交易员培训和全职交易员培训学员。',
    'Space-time trading official partner brokers: EC Markets, TickMill, Binance, FTMO, FundedNext. Providing forex traders with highest rebates, ultra-low spreads and exclusive offers. Supporting day trader training and full-time trader training students.',
